      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-white/10 border-b border-white/20">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button className="bg-white text-green-700 hover:bg-primary hover:text-white  ">Sign Up</Button>
            </Link>
          </div>
        </div>
      </header>
      ...
      <footer className="backdrop-blur-md bg-black/20 border-t border-white/20 py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/70 mb-4 md:mb-0">© {new Date().getFullYear()} AfroValley. All rights reserved.</p>
